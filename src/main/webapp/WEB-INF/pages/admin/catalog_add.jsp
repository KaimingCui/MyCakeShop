        ...
        <div class="tray tray-center">
            ...
            <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
                <div class="panel heading-border">
                    <form method="post" action="${pageContext.request.contextPath}/admin/Catalog/add.do" id="admin-form">
                        <div class="panel-body bg-light">
                            ...
                            <div class="panel-footer text-right">
                                ...
                                <button type="button" class="button" onclick="javascript:window.location.href='${pageContext.request.contextPath}/admin/Catalog/list.do';"> 返回 </button>
                            </div>
                        </div>
                    </form>
                </div>
